...
void tw_set_br(int16_t bitrate_kHz)
{
    ...
    { 
        ...
        uart_print_uint(64); uart_put('\n');
  } 
    else if( (int16_t)(F_CLK/4000)/bitrate_kHz - 16 > 255 )
    {
         TW_SET_PS(TW_PS_16);
         br_div = ((F_CLK/bitrate_kHz/1000)-16)/32;
         uart_print_uint(16); uart_put('\n');
   }
    else if( (int16_t)(F_CLK/1000)/bitrate_kHz - 16 > 255 )
    {
         TW_SET_PS(TW_PS_4);
         br_div = ((F_CLK/bitrate_kHz/1000)-16)/8;
         uart_print_uint(4); uart_put('\n');
    }
    else  br_div = ((F_CLK/bitrate_kHz/1000)-16)/2;
